...
export default function RowEditingDemo() {
  ...
  const onRowEditComplete = async (e) => {
    if (IDMLData) {
      ...
      console.log("Edited Row Data:", editedRowData?.TRANSLATED_CONTENT);
      console.log("Edited Row Data:", editedRowData?.ID);

      // Compare the original content with the modified content
      const isContentModified =
        _IDMLData[index]?.TRANSLATED_CONTENT !== newData?.TRANSLATED_CONTENT;
      ...
      const payload = [
        {
          ID: newData?.ID,
          TRANSLATED_CONTENT: newData?.TRANSLATED_CONTENT,
        },
      ];
